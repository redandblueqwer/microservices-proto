...
type OrderClient interface {
	...
	// 更新订单状态
	UpdateStatus(ctx context.Context, in *UpdateOrderStatusRequest, opts ...grpc.CallOption) (*UpdateOrderStatusResponse, error)
}
...
func (c *orderClient) UpdateStatus(ctx context.Context, in *UpdateOrderStatusRequest, opts ...grpc.CallOption) (*UpdateOrderStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServer interface {
	...
	// 更新订单状态
	UpdateStatus(context.Context, *UpdateOrderStatusRequest) (*UpdateOrderStatusResponse, error)
...
func (UnimplementedOrderServer) UpdateStatus(context.Context, *UpdateOrderStatusRequest) (*UpdateOrderStatusResponse, error) {
...
func _Order_UpdateStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).UpdateStatus(ctx, req.(*UpdateOrderStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
